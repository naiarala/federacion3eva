...
public class MetalDAO implements operacionesCRUD<Metal> {
	...
	public boolean insertarConID(Metal m) {
		boolean ret = false;
//
//		String consultaInsertStr = "insert into metal(idOro, pureza, maxPureza, idMaxPureza) values (?,?,?,?,?)";
//		try {
//			if (this.conex == null || this.conex.isClosed())
//				this.conex = ConexBD.establecerConexion();
//			PreparedStatement pstmt = conex.prepareStatement(consultaInsertStr);
//			pstmt.setLong(1, m.getIdOro());
//			java.sql.Date fechaSQL = java.sql.Date.valueOf(m.getFechaInicio());
//			pstmt.setFloat(2, m.getPureza());
//			java.sql.Date fechaSQL1 = java.sql.Date.valueOf(m.getFechaFin());
//			pstmt.setDate(3, fechaSQL1);
//			pstmt.setString(4, m.getMotivoBaja());
//			pstmt.setLong(5, m.getIdEmpleado());
